...
[Seizure First Aid Simulator](../../sims/seizure-first-aid/index.md).
...
- Do **not** put anything in their mouth. (You cannot swallow your tongue; objects can cause
  injury or choking.)
...
!!! danger "Follow the student's plan"
    If a student has a seizure action plan on file, it takes priority. It may specify rescue
    medication and a different time threshold for calling 911. Know where plans are kept.
