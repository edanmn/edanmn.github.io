...
1. Tell your school nurse or principal, in writing, that your child has a seizure disorder and
   ask to set up a Seizure Action Plan.
...
- Help keep the [district finder](../05-the-data-case-study/index.md) current by reporting
  districts that have adopted a plan.
...
3. **Deliver** free, ready-to-use resources to the highest-need districts, and hand the map to
   partners like the Epilepsy Foundation of Minnesota who can act at scale.
