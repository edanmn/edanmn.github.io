...
with MINCEP, Abbott Northwestern, and the Minnesota Epilepsy Group with Children's Minnesota.
...
Distance is a real barrier and it is also not the end of the conversation. Ask whether the
center offers a telehealth first visit, whether they run outreach clinics closer to you, and
whether Medical Assistance will cover travel. Those answers vary by system and they are worth
asking for by name.
...
- If cost is the barrier rather than distance, start with
...
!!! note "What this page is"
    ...
    are ours, from public federal data, and the methods are published. The clinical material
    belongs to the sources we link. Corrections to edanmnorg@gmail.com.
