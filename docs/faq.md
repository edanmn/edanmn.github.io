...
??? question "We have no school nurse. What do we do?"
    ...
    The free training below covers what that person needs to know, and the packet gives you a
    ready plan template.
...
??? question "What is the single highest-impact thing we can do?"
    ...
    and complete it, then make sure a trained person is named at each building.
