...
Written for a parent or guardian in Minnesota. You are probably reading this late at night.
Here is what actually needs doing, in order, and what can wait.
...
Minnesota law, Minn. Stat. 121A.24, requires the school to keep a seizure action plan for a
student with a diagnosed seizure disorder and to have trained staff who can carry it out. You
do not have to argue for this, and you do not need a lawyer to ask.

1. Send the plan to the school nurse in writing. There is a copy-paste email in
   [how to help](../../chapters/06-how-to-help/index.md).
2. Ask who is trained, and who covers when that person is absent. The gap is usually the bus,
   the field trip and the substitute.
3. Ask whether the school posts anything publicly, and check what your district already has:
   [find your district](../../find-your-district/index.md).
4. If your child needs accommodations beyond the health plan, learn the difference between a
   504 plan and an IEP before the meeting, not during it:
   [your child's rights](../../chapters/07-your-childs-rights/index.md) and the
   [path-finder](../../sims/504-vs-iep/index.md).
...
[Free school packet](https://edanmn.org/packet/EDAN-Seizure-Safe-Schools-Packet.pdf){ .md-button }

!!! warning "This is information, not medical advice"
    Written by students, sourced, and not yet reviewed by a clinician. Your child's care belongs
    to you and their clinician. In an emergency, call 911.
